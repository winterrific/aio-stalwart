...
| `ENSURE_MAIL_PORT_CONFIG`        | Manage mail exchange port configuration.<br/>This port is used to receive emails.                                                                                                                       | `ON`    | `https://mail.$NC_DOMAIN/account/Settings/x:NetworkListener` |
| `ENSURE_SUBMISSION_PORT_CONFIG`  | Manage mail submission port configuration.<br/>This port is used to send emails.                                                                                                                        | `ON`    | `https://mail.$NC_DOMAIN/account/Settings/x:NetworkListener` |
| `ENSURE_IMAP_PORT_CONFIG`        | Manage IMAP port configuration.<br/>This port is used to read emails.                                                                                                                                   | `ON`    | `https://mail.$NC_DOMAIN/account/Settings/x:NetworkListener` |
| `ENSURE_WEB_PORT_CONFIG`         | Manage web port configuration.<br/>This port is used to access the WebAdmin.                                                                                                                            | `ON`    | `https://mail.$NC_DOMAIN/account/Settings/x:NetworkListener` |
| `ENSURE_MANAGESIEVE_PORT_CONFIG` | Manage managesieve port configuration.<br/>This port is used to manage filters.                                                                                                                         | `ON`    | `https://mail.$NC_DOMAIN/account/Settings/x:NetworkListener` |
| `ENSURE_STORAGE_CONFIG`          | Manage storage configuration.                                                                                                                                                                           | `ON`    | `https://mail.$NC_DOMAIN/account/Settings/x:DataStore`       |
| `ENSURE_DIRECTORY_CONFIG`        | Manage directory configuration.<br/>This is the system to manage users.                                                                                                                                 | `ON`    |                                                              |
| `ENSURE_FILE_LOGGING_CONFIG`     | Manage file logging configuration.<br/>This provides access to logs from the WebAdmin.                                                                                                                  | `ON`    | `https://mail.$NC_DOMAIN/account/Settings/x:Tracer`          |
| `ENSURE_CONSOLE_LOGGING_CONFIG`  | Manage console logging configuration.<br/>This provides access to logs from Docker and the master container interface.                                                                                  | `ON`    | `https://mail.$NC_DOMAIN/account/Settings/x:Tracer`          |
| `ENSURE_FALLBACK_ADMIN_CONFIG`   | Manage fallback admin configuration.<br/>This is the admin account to access the WebAdmin.                                                                                                              | `ON`    |                                                              |
| `ENSURE_AIO_CLAMAV_CONFIG`       | Manage ClamAV configuration.<br/>This is used to scan emails for viruses.                                                                                                                               | `OFF`   | `https://mail.$NC_DOMAIN/account/Settings/x:MtaMilter`       |
| `AUTO_CONFIG_TLS_CERT`           | Manage configuration of TLS certificates from the Caddy community container.<br/>This is used to secure the connection for the mail protocol.                                                           | `ON`    | `https://mail.$NC_DOMAIN/account/Settings/x:Certificate`     |
...
| `ENSURE_DNSSEC_VALIDATE`         | The setup script check on startup, if the local DNS resolver supports DNSSEC validation. If not, Quad9 is configured as DNS resolver for stalwart. This is needed to ensure that DANE Support can work. | `ON`    | `https://mail.$NC_DOMAIN/account/Settings/x:DnsResolver`     |                                                              |
